...
function createServer(ctx) {
  ...
  // This metadata-only route never needs the large image/import parser budget.
  // Register its strict parser first; express.json skips a body already parsed.
  app.use("/api/duplicates/not-duplicate", express.json({ limit: "384kb" }));
